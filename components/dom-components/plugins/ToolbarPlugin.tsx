...
export default function ToolbarPlugin() {
  ...
  return (
    <div className="toolbar" ref={toolbarRef}>
      ...
      <button
        onClick={() => {
          editor.dispatchCommand(INSERT_BIBLE_VERSE_COMMAND, undefined);
        }}
        className="toolbar-item spaced"
        aria-label="Insert Bible Verse"
      ...
      >
        <svg 
          ...
          fill="currentColor"
        >
          {/* Simple Bible book with cross icon */}
          <path d="M19 2H5c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 18H5V4h14v16z" />
          <path d="M12 7v7M9 10.5h6" strokeWidth="1.5" stroke="currentColor" fill="none" />
          <path d="M6 19h12c0-3-4-5-6-5s-6 2-6 5z" />
        </svg>
      </button>
    </div>
  );
